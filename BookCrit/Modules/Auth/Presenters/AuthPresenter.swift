...
class AuthPresenter: AuthPresentation {
	...
	func didLoginWithEmail(_ email: String, password: String, phoneNumber: String, name: String) {
		self.interactor.firebaseEmailLogin(with: email, password: password, phoneNumber: phoneNumber, name: name)
	}
	
	func didRegisterWithEmail(_ email: String, password: String, phoneNumber: String, name: String){
		self.interactor.firebaseEmailRegister(with: email, password: password, phoneNumber: phoneNumber, name: name)
	}
